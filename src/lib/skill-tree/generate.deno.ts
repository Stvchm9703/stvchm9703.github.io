...
const nodes = [
    ...
    // layer 3 limit-9
    { id: 11, name: 'Node', query: ['lanaguage:js', 'path:*.js', 'path:*.jsx'], layer: 2, parent: 1, color: '#68a063' },
    { id: 12, name: 'solid-js', query: ['lanaguage:jsx', 'path:*.jsx'], layer: 2, parent: 1, color: '#4377bb' },
    ...
    { id: 18, name: 'Vite', query: ['\{ path:vite.config.*'], layer: 4, parent: 17, color: '#646c70' },
    { id: 19, name: 'Design System', layer: 4, parent: 18, color: '#ff4785' },
    { id: 20, name: 'Tailwind', layer: 3, parent: 11, color: '#38b2ac' },
    { id: 21, name: 'SCSS OR SASS', query: ['\{ path:*.scss'], layer: 3, parent: 11, color: '#cc6699' },
    { id: 22, name: 'PostCSS', layer: 3, parent: 11, color: '#dd3a0a' },
    { id: 23, name: 'Tauri', layer: 4, parent: 10, color: '#24c8db' },

    // layer 2 limit-6 
    { id: 24, name: 'CSharp', query: ['language:csharp'], layer: 2, parent: 2, color: '#239120' },
    { id: 25, name: 'Golang', query: ['language:go'], layer: 2, parent: 2, color: '#00acd7' },
    { id: 26, name: 'Rust', query: ['language:rust'], layer: 2, parent: 2, color: '#dea584' },
    // { id: 27, name: 'Database', layer: 2, parent: 3, color: '#4479a1' },
    { id: 28, name: 'Python', query: ['lanaguage:python'], layer: 2, parent: 3, color: '#306998' },
    ...
    { id: 36, name: 'Docker', query: ['path:*docker*'], layer: 3, parent: 4, color: '#2496ed' },
    // layer 4 limit-12

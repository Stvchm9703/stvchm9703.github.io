...
>
    ...
    <BannerGridCell align="left">
        <h1 class="text-light-50 text-5xl leading-loose">
            Steven - Cheng Ho Man
        </h1>
...
>
  ...
  {/each} -->
    ...
    <BannerGridCell align="right" row={11}>
        ...
        <div class="text-light-50 text-lg">
            make some small util tools for myself, to make my life easier; but
            not a big fans of code leeting
            <div class="grid w-24 h-24"></div>
        </div>
    </BannerGridCell>
    ...
    <BannerGridCell align="right" row={13}>
        ...
        <div class="text-light-50 text-lg">
            nice to type on, nice to look at. speed up my typing speed; also,
            make for cool stuff
        </div>
        <img
    ...
    <BannerGridCell align="left" row={14}>
        ...
        <div class="text-light-50 text-lg">
            coffee energy, enpower me everyday
        </div>
        <img
            class="mt-5 w-full min-h-24 object-contain"
            src={BaseImage_2}
    ...
    <div class="flex flex-col self-center max-w-full items-start">
        <div class="px-6 py-4 rounded-lg bg-dark-700/45 mx-8 mb-3">
            ...
            <p class="text-light-800">
                Those I known and those I am learning, all skill and tech are
...
<Banner id="contact" containerClass="">
    ...
    <div class="flex flex-col">
        <h1 class="text-center text-3xl text-light-50 font-light">
            Contact Me
        </h1>
            ...
            <table class="table-auto">
                <tbody>
                    <tr class=" border-b-1 border-white">
                        <td class="py-3 text-2xl text-light-50 font-light"
                            >Email:</td
                        >
                    ...
                    <tr class=" border-b-1 border-white">
                        <td class="py-3 flex flex-col">
                            <span class="text-2xl text-light-50 font-light"
                                >Tel:</span
                            >
                        </td>
                        <td class="py-3">

<h1 align=center>Steven (StvChm9703) </h1>

<h3 align="center">developer from Hong Kong, especially Frontend, Backend,</h3>
...
- Languages: `Python`, `JavaScript`, `HTML`, `CSS`, `PostgreSQL`, `SurrealDB`, `Golang`
- Frameworks: `gRPC`, `Twirp`, `Vuejs`, `Nuxtjs`, `UnoCSS(Tailwind)`, `Sklearn`
- repositories: 
  - [JobSeek-service](https://github.com/Stvchm9703/job-seek)
      
      mono-repo with multiple backend services for web-scraping, data-entry and data-processing, with mirco-service architecture;

  - [JobSeek-frontend](https://github.com/Stvchm9703/job-seek-web-app)
  ...
  - [JobSeek-python](https://github.com/Stvchm9703/job-seek-v3)
...
repositories : 
- [Main Maintainance Repo](https://github.com/Stvchm9703/Unlight-Zwei)
  
  Main version control and Assets Data entry


- [Game Client Program](https://github.com/Stvchm9703/unlight-zwei-unity)

  Unity Engine Based, remake the game logic and Game UI

- [Duel Service](https://github.com/Stvchm9703/unlight-zwei-game-duel-service)

  For damage calculation logic, including snapshoting the game in cache;

- [Room Service](https://github.com/Stvchm9703/unlight-zwei-room-service)

  For the online room pairring, implement with Redis as Caching Data;

- [Script Runner](https://github.com/Stvchm9703/Unlight-Zwei-ScptRunner/)
